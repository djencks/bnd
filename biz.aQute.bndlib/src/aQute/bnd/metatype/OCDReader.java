...
public class OCDReader extends ClassDataCollector {
	...
	OCDReader(Analyzer analyzer, Clazz clazz, Set<String> flags, List<ExtensionReader> extensions) {
	...
	static OCDDef getOCDDef(Clazz c, Analyzer analyzer, Set<String> flags, List<ExtensionReader> extensions) throws Exception {

		OCDReader r = new OCDReader(analyzer, c, flags, extensions);
		return r.getDef();
	}
